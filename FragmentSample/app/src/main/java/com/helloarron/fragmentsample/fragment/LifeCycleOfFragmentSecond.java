 ...
 */
public class LifeCycleOfFragmentSecond extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Log.i("Main", "Fragment-2--onCreateView");
        return view;
    }
    ...
    public void onAttach(Activity activity) {
        ...
        Log.i("Main", "Fragment-2--onAttach");
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("Main", "Fragment-2--onCreate");
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        Log.i("Main", "Fragment-2--onActivityCreated");
    }
    ...
    public void onResume() {
        super.onResume();
        Log.i("Main", "Fragment-2--onResume");
    }
    ...
    public void onDestroyView() {
        super.onDestroyView();
        Log.i("Main", "Fragment-2--onDestroyView");
    }
    ...
    public void onDestroy() {
        super.onDestroy();
        Log.i("Main", "Fragment-2--onDestroy");
    }
    ...
    public void onDetach() {
        super.onDetach();
        Log.i("Main", "Fragment-2--onDetach");
    }
}
